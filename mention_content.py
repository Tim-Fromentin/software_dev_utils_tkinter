...
from mention_action_create_doc import mention_action_create_doc
from mention_add_new_mention import mention_add_new_mention



def mention_content(mention_frame_widget):
    global mention_label_name_doc, mention_btn_create_doc, mention_title, mention_input_name_doc, mention_label_title, mention_label_position, mention_position, mention_label_type, mention_type, mention_label_source, mention_source, mention_btn_add_mention
