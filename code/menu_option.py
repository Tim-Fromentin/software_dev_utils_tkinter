...
def menu_option_frame(main,home_frame_action, mention_frame_action, compressor_frame_action, db_generator_action, qrcode_generator_action):
    ...
    btn_choice_qr_generator = MenuButton(menu_option, text="Qr code generator", command=qrcode_generator_action).pack(pady=(10, 0))
